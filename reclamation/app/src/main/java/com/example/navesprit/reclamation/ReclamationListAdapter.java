...
public class ReclamationListAdapter extends RecyclerView.Adapter<ReclamationListAdapter.MyViewHolder> {

    private Context context;
    private List<Reclamation> recList;

    public ReclamationListAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailReclamationActivity.class);
